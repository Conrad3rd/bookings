...
var theTests = []struct {
	...
	// 	{key: "email", value: "ah@hs.com"},
	// 	{key: "phone", value: "0321456789"},
	// }, http.StatusOK},
}
...
func TestRepository_PostReservation(t *testing.T) {
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("PostReservation handler faild when trying when trying to fail inserting reservation: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
