...
import (
	...
	"github.com/conrad3rd/bookings/internal/repository/dbrepo"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	msg := models.MailData{
		...
		From:     "me@here.com",
		Subject:  "Test subject Reservation Confirmation",
		Content:  htmlMessage,
		Template: "basic.html",
	}
	...
	// send notification to propery owner
	htmlMessage = fmt.Sprintf(`
...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Println("Wrong Authentication -->", err)
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for name, _ := range r.PostForm {
		if strings.HasPrefix(name, "add_block") {
			explolded := strings.Split(name, "_")
			roomID, _ := strconv.Atoi(explolded[2])
			// insert a new block
			log.Println("Would insert block for room id", roomID, "for date", explolded[3])
		}
	}
